      ...
      <div className="App">
        ...
        <HashRouter>
          <Switch>
              ...
              <Route exact={true} render={(props)=>(<SmartForm  {...props} formType={"Login"}/>)} path={"/login"}/>
              <Route exact={true} render={(props)=>(<SmartForm  {...props} formType={"Registration"}/>)} path={"/register"}/>
